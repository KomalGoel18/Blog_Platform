    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md bg-white rounded-2xl shadow-sm p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Join our developer community and start writing today</p>
          </div>
          ...
          <form className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
              <p className="mt-2 text-xs text-gray-500">Must be at least 8 characters with one number.</p>
            </div>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              ...
              >
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="#2DA44E">
      ...
      <footer className="bg-white border-t border-gray-200 px-6 py-4">
        <div className="max-w-7xl mx-auto text-center text-sm text-gray-600">
          <p>© 2024 BlogPlatform Inc. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
